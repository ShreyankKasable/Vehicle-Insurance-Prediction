...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj1Estimator]:
        ...
        try:
            ...
            proj_estimator = Proj1Estimator(bucket_name=bucket_name,
    ...
    def evaluate_mode(self) -> EvaluateModelResponse:
        """
        ...
        try:
            ...
            if best_model is not None:
                ...
                logging.info(f"F1_Score-Production Model: {best_model_f1_score}, F1_score-New Trained Mode: {trained_model_f1_score}")
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            evaluate_model_response = self.evaluate_mode()
